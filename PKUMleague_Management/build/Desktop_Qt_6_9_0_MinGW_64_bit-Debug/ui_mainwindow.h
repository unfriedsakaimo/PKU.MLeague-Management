...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        showGamesButton = new QPushButton(verticalLayoutWidget);
        showGamesButton->setObjectName("showGamesButton");
        showGamesButton->setMinimumSize(QSize(0, 60));
        QFont font;
        font.setFamilies({QString::fromUtf8("\345\271\274\345\234\206")});
        font.setPointSize(14);
        showGamesButton->setFont(font);

        verticalLayout->addWidget(showGamesButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        showGamesButton->setText(QCoreApplication::translate("MainWindow", "\346\237\245\350\257\242\350\265\233\347\250\213", nullptr));
