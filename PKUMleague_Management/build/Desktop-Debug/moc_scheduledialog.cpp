...
static constexpr auto qt_meta_stringdata_ZN14ScheduleDialogE = QtMocHelpers::stringData(
    "ScheduleDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14ScheduleDialogE[] = {
...
Q_CONSTINIT const QMetaObject ScheduleDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14ScheduleDialogE.offsetsAndSizes,
    qt_meta_data_ZN14ScheduleDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14ScheduleDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ScheduleDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14ScheduleDialogE.stringdata0))
